...
const API_BASE_URL =
  ...
  "https://covercraft-backend.onrender.com/api"; // "https://covercraft-backend.onrender.com/api"
                        ...
                        >
                          <ListItemAvatar>
                            <Avatar
                              ...
                              variant="square"
                              sx={{
                                width: { xs: 80, sm: 100, md: 120 }, // Responsive width scaling
                                height: { xs: 100, sm: 140, md: 160 }, // Matching height for square shape
                                mb: { xs: 1, sm: 0 }, // Margin bottom for spacing on small screens
                                objectFit: "cover", // Ensures image fits perfectly without distortion
                                borderRadius: 1, // Slight rounding for a modern look
